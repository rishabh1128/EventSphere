...
export async function POST(req: NextRequest) {
  ...
  const mailOptions = {
    ...
    <div style="padding: 20px; background-color: #f4f4f4; border-radius: 10px; width: 80%; margin: 0 auto;">
      ...
      <table style="border-collapse: collapse; width: 100%; margin-top: 20px;">
        ...
        <tbody>
          <tr style="background-color: #f9f9f9;">
            <td style="border: 1px solid #ddd; padding: 12px;text-align:center">${eventName}</td>
            <td style="border: 1px solid #ddd; padding: 12px;text-align:center">${ticketId}</td>
            <td style="border: 1px solid #ddd; padding: 12px;text-align:center">${formatPrice(
              displayCost
            )}</td>
            <td style="border: 1px solid #ddd; padding: 12px;text-align:center">${startDateTime}</td>
            <td style="border: 1px solid #ddd; padding: 12px;text-align:center">${endDateTime}</td>
          </tr>
        </tbody>
      </table>
